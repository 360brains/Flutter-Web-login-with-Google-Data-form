...
import 'package:firebaseauth/config/palette.dart';
...
class BackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // canvas.drawPaint(Paint()..color = Palette.darkOrange);
  }
  ...
  void _addPointsToPath(Path path, List<Point> points) {
    if (points.length < 3) {
      throw UnsupportedError('Need three or more paints to create a path');
    }
